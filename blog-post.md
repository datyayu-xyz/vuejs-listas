Ya hemos revisado como usar Vue.js para [interactuar con el DOM de manera sencilla](/vuejs-dom/) pero ahora toca ver cómo mostrar contenido basado en una o varias condiciones y cómo trabajar con listas de la manera correcta.

---

*Este post es parte de [una serie acerca de VueJS](/tag/vue-js/). Si eres nuevo usando Vue.js y no has leido los post anteriores, te recomiendo leer la [Introduccion a Vue.js](/introduccion-a-vue-js/) y [como interactuar con el DOM usando Vue](/vuejs-dom) para que tengas una mejor comprension de este post*
